...
// export default function Home({user, createPopUp, redirect, setGlobalJobs, globalJobs}) {
...
//           <FilterModal handleClose={handleCloseModal} myjobs={myjobs}  setmyjobs={setmyjobs} show={showModal}/>
