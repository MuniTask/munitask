    ...
    <MDBContainer className='p-0 profile-container mt-5' fluid>
        ...
        <MDBCol size='3'>
          <MDBTabs className='flex-column text-center'>
            ...
            <MDBTabsItem>
              <MDBTabsLink className='profile-tab' onClick={() => handleVerticalClick('tab4')} active={verticalActive === 'tab4'}>
        ...
        <MDBCol size='9'>
          <MDBTabsContent className='mt-5 '>
            ...
            <MDBTabsPane show={verticalActive === 'tab3'}>
                ...
                <InterestForm writeInterestForm={writePersonalInfo}/>
                </MDBTabsPane>
            <MDBTabsPane show={verticalActive === 'tab4'}>
                <h4 className='display-5 '>Personal Information</h4>
                <PersonalInfo writePersonalInfo={writePersonalInfo}/>
            </MDBTabsPane>
          </MDBTabsContent>
        </MDBCol>
      </MDBRow>
