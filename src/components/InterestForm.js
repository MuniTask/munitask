      ...
      <form onSubmit={(e) => { writeInterestForm(e);handleEventPush(e) }} >
          <div className="d-flex flex-column mb-4">
            <div className="form-group mb-3">
              ...
              <input type="date" data-testid='intFormJobStartInput' id="start" className="form-control" name="job_start" min="2022-01-01" max="2024-01-01" />
            ...
            <div className="form-group ">
              ...
              <input type="date" data-testid='intFormJobEndInput' id="end" className="form-control" name="job_end"
                min="2022-01-01"
                max="2024-01-01" />
            </div>
          </div>
          <div className="mb-3">
            ...
            <textarea name="certifications" data-testid='intFormCertificationsInput' className="form-control"  id="certifications" rows="5" cols="50" ></textarea>
          </div>
          
          <div>
            <label htmlFor="other-info">Is there anything else you'd like us to know? </label>
            <textarea name="other_info" className="form-control" data-testid='intFormOtherInfoInput' id="other_info" rows="5" cols="50" ></textarea>
          </div>
      

        <button type="submit" data-testid='intFormSubmitBtn' className="btn btn-primary mt-4">
          Declare Interest
        </button>
      </form>
    </MDBContainer>
